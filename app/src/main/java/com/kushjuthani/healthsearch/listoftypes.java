...
public class listoftypes extends AppCompatActivity {
    ...
    TextView infoText,sciText,typeidText,doc_hos;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doc_hos = findViewById(R.id.doc_hos);
